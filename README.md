...
|OS(kernel) version|ubuntu 16.04.1 LTS(4.4.0-47-generic)|CentOS 7.4.1708(3.10.0-693.17.1.el7.x86_64)|-------|-------|ubuntu 16.04.1 LTS(4.4.0-47-generic)|Oracle Linux 7.3(4.1.12-112.14.13.el7uek.x86_64)|-------|-------|
